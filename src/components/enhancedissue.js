...
class EnhancedIssue extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            columns: [
                { title: "Title", field: "title", editable: (Auth.isServer) ? 'never' : 'onUpdate' },
                { title: "Description", field: "description", editable: (Auth.isServer) ? 'never' : 'onUpdate' },
                { title: "Course", field: "course", editable: (Auth.isServer) ? 'never' : 'onUpdate' },
                {
                    title: "Status",
                    field: "status",
                    editComponent: props => {
                ...
                <Container>
                    ...
                    <div className={classes.paper}>
                        <MaterialTable
                            ...
                            editable={{
                                onRowAdd: (Auth.isServer) ? null : newData =>
                                    new Promise(async (resolve, reject) => {
